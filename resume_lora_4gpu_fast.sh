...
# Resume 7B LoRA Training from Step 100 - FAST Configuration
# Using GPUs 0,2,3,4
...
# Ray temporary directory (keep short to avoid socket path length issues)
export RAY_TMPDIR=/tmp/ray_r
export TMPDIR="$RAY_TMPDIR"
export TEMP="$RAY_TMPDIR"
export TMP="$RAY_TMPDIR"
mkdir -p "$RAY_TMPDIR"

# Use 4 GPUs (0,2,3,4) - as specified by user
...
SAVE_FREQ=50  # Save every 100 steps for better monitoring
...
echo "================================================================================"
echo "MemAgent PPO Training - RESUME from Step 100 (GPUs 0,2,3,4)"
echo "================================================================================"
echo "Experiment: ${EXP}"
echo "Resume from: ${PROJ_DIR}"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.resume_from_path=${PROJ_DIR} \
